...
GET_VERSION_FRAME_LEN=13
ACK_FRAME_LEN=6

# Ожидаемая версия прошивки (CMD_GET_VERSION, Config/config.h FW_VERSION_*).
FW_VERSION_MAJOR_EXPECT="${FW_VERSION_MAJOR_EXPECT:-1}"
FW_VERSION_MINOR_EXPECT="${FW_VERSION_MINOR_EXPECT:-1}"
